"""Unit tests for DMS WI Connector API."""
...
class TestPolarionDmsWiConnectorApi(unittest.TestCase):
    """Test PolarionDmsWiConnectorApi class."""

    def setUp(self) -> None:
        """Set up test fixtures."""
        self.mock_connection = Mock()
        self.api = PolarionDmsWiConnectorApi(self.mock_connection)

    def test_init(self) -> None:
        """Test initialization."""
        self.assertEqual(self.api.extension_name, "dms-wi-connector")
