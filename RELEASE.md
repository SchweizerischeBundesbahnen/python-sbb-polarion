...
2. Following the triumphant launch of the initial version, the action automatically generates another pull request to advance the version to 1.0.1-dev. Prompt approval of this pull request is encouraged post the inaugural release.
...
4. Subsequent to each release, the process iterates to update the version to X.Y.Z-dev, thereby preparing a new pull request for the forthcoming X.Y.Z version release.
