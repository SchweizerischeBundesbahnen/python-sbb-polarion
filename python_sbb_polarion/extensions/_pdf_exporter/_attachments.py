"""PDF Exporter test run attachments mixin.

This module provides PDF-specific attachment methods.
...
class TestRunAttachmentsMixin(SharedExporterAttachmentsMixin):
    """PDF Exporter test run attachment operations.
    ...
    - get_test_run_attachments() - List attachments with testCaseFilterFieldId support
    """

    # =========================================================================
    # Test Run Attachments (PDF-specific)
    # =========================================================================
    ...
    @restapi_endpoint(
        ...
        query_params={
            "revision": "revision",
            "filter": "filter_query",
            "testCaseFilterFieldId": "test_case_filter_field_id",
        },
    ...
    def get_test_run_attachments(
        ...
        test_case_filter_field_id: str | None = None,
    ) -> Response:
        ...
        if test_case_filter_field_id:
            params["testCaseFilterFieldId"] = test_case_filter_field_id
